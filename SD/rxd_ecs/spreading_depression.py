...
pc.set_maxstep(1000)  # required when using multiple processes
...
def plot_rec_neurons():
    ...
    for i in range(nhost):
        ...
        for idx in range(somaV[0].size()):
            ...
            pyplot.title('Neuron membrane potentials; t = %gms' % (idx * 1000))
