...
class SyppyrRS(Cell):  #
    ...
    class TCR(Cell):  #
        def __init__(self, x, y, z, num):
            ...
            # ---------------soma----------------
            for mechanism_s in ['extracellular', 'naf_tcr', 'kdr', 'ka', 'k2',
                                'pas']:
                self.soma.insert(mechanism_s)

            self.soma(0.5).naf_tcr.gbar = 0.4
            self.soma(0.5).kdr.gbar = 0.4
            ...
            # ---------------dend----------------
            for mechanism_d in ['naf_tcr', 'napf_tcr', 'kdr','ka', 'kc', 'km', 'k2', 'kahp_slower', 'cal', 'cat', 'ar', 'cad',  'pas']:
                self.dend.insert(mechanism_d)
                self.dend1.insert(mechanism_d)
                self.dend2.insert(mechanism_d)
                self.dend3.insert(mechanism_d)
            ...
            self.dend1(0.5).cat.gbar = 0.0005
            self.dend1(0.5).ar.gbar = 0.00025
            ...
            self.dend2(0.5).cat.gbar = 0.0005
            self.dend2(0.5).ar.gbar = 0.00025
            ...
            self.dend3(0.5).cat.gbar = 0.0005
            self.dend3(0.5).ar.gbar = 0.00025
            ...
            self.dend4(0.5).cat.gbar = 0.0005
            self.dend4(0.5).ar.gbar = 0.00025
    ...
    class nRT(Cell):  #
        def __init__(self, x, y, z, num):
            ...
            # ---------------dend----------------
            for mechanism_d in ['naf_tcr', 'naf2', 'napf', 'kdr_fs', 'ka', 'kc', 'km', 'k2', 'kahp_slower', 'cal', 'cat_a', 'ar', 'cad',  'pas']:
                self.dend.insert(mechanism_d)
                self.dend1.insert(mechanism_d)
                self.dend2.insert(mechanism_d)
                self.dend3.insert(mechanism_d)
