...
class Cell:
    def __init__(self, x, y, z, num):
        ...
        # self.soma_axon = [self.soma, self.axon]
...
class Bask23(Cell):
    def __init__(self, x, y, z, num):
        ...
        # self.soma(0.5).kc_fast_cc.gbar = 0.025
        # self.soma(0.5).ka.gbar = 0.001
        # self.soma(0.5).k2.gbar = 0.0005 # missing in this neuron
        # self.soma(0.5).km.gbar = 0.0005 # missing in this neuron
        # self.soma(0.5).kahp_slower.gbar = 0.0001 # missing in this neuron
        # self.soma(0.5).cal.gcalbar = 0.0001
        # self.soma(0.5).cat.gcatbar = 5.E-05 # missing in this neuron
        # self.soma(0.5).ar.gbar = 2.5E-05 # missing in this neuron
        ...
        # self.dend(0.5).kdr_fs.gbar = 0.1  # 0.018
        self.dend(0.5).nap.gnapbar = 0.0006  # 0.000018
        # self.dend(0.5).kdr_fs_cc.gbar = 0.1
        # self.dend(0.5).kc_fast_cc.gbar = 0.025
        # self.dend(0.5).ka.gbar = 0.001
        # self.dend(0.5).k2.gbar = 0.0005
        # self.dend(0.5).km.gbar = 0.0005
        # self.dend(0.5).kahp_slower.gbar = 0.0001
        # self.dend(0.5).cal.gcalbar = 0.0001
        # self.dend(0.5).cat.gcatbar = 5.E-05
        ...
        # self.dend1(0.5).naf2.gbar = 0.06  # 0.00018 * 10
        # self.dend1(0.5).kdr_fs.gbar = 0.1  # 0.018 * 0.5
        ...
        # self.dend1(0.5).kdr_fs_cc.gbar = 0.1
        # self.dend1(0.5).kc_fast_cc.gbar = 0.025
        ...
        # self.dend1(0.5).cal.gcalbar = 0.0001
        # self.dend1(0.5).cat.gcatbar = 5.E-05
        ...
        # self.dend2(0.5).naf2.gbar = 0.01  # 0.00018 * 10
        # self.dend2(0.5).kdr_fs.gbar = 0.01  # 0.018 * 0.5
        # self.dend2(0.5).kapin.gkabar = 0.001  # 0.000032 * 15 * 10
        self.dend2(0.5).nap.gnapbar = 0.0001
        # self.dend2(0.5).kdr_fs_cc.gbar = 0.01
        # self.dend2(0.5).kc_fast_cc.gbar = 0.025
        ...
        # self.dend2(0.5).cal.gcalbar = 0.0002
        # self.dend2(0.5).cat.gcatbar = 0.002
        ...
        # self.dend3(0.5).naf2.gbar = 0.01  # 0.00018 * 10
        # self.dend3(0.5).kdr_fs.gbar = 0.01  # 0.018 * 0.5
        # # self.dend3(0.5).kapin.gkabar = 0.001  # 0.000032 * 15 * 10
        self.dend3(0.5).nap.gnapbar = 0.0001
        # # self.dend3(0.5).kdr_fs_cc.gbar = 0.01
        # self.dend3(0.5).kc_fast_cc.gbar = 0.025
        ...
        # self.dend3(0.5).cal.gcalbar = 0.0002
        # # self.dend3(0.5).cat.gcatbar = 0.002
        ...
        # self.dend4(0.5).naf2.gbar = 0.01  # 0.00018 * 10
        # self.dend4(0.5).kdr_fs.gbar = 0.01  # 0.018 * 0.5
        # self.dend4(0.5).kapin.gkabar = 0.001  # 0.000032 * 15 * 10
        self.dend4(0.5).nap.gnapbar = 0.0001
        # self.dend4(0.5).kdr_fs_cc.gbar = 0.01
        # self.dend4(0.5).kc_fast_cc.gbar = 0.025
        ...
        # self.dend4(0.5).cal.gcalbar = 0.0002
        # self.dend4(0.5).cat.gcatbar = 0.002
...
class Axax23(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        # self.soma(0.5).cal.gcalbar = 0.0001
        # self.soma(0.5).cat.gcatbar = 5.E-05
        self.soma(0.5).IKsin.gKsbar = 0.000725 * 0.1
        self.soma(0.5).hin.gbar = 0.00001
        ...
        # self.dend(0.5).cal_cc.gbar = 0.0001
        # self.dend(0.5).ar.gbar = 2.5E-05
        ...
        # self.dend1(0.5).cal_cc.gbar = 0.0001
        # self.dend1(0.5).ar.gbar = 2.5E-05
        ...
        # self.dend2(0.5).km.gbar = 0.0005
        # self.dend2(0.5).kahp_slower.gbar = 0.0001
        # self.dend2(0.5).cat.gcatbar = 5.E-05
        # self.dend2(0.5).k2_cc.gbar = 0.0005
        # self.dend2(0.5).cal_cc.gbar = 0.0001
        # self.dend2(0.5).ar.gbar = 2.5E-05
        # self.dend2(0.5).cad.beta = 0.05
        # self.dend2(0.5).cad.phi = 520000.
        ...
        # self.dend3(0.5).km.gbar = 0.0005
        # self.dend3(0.5).kahp_slower.gbar = 0.0001
        # self.dend3(0.5).cat.gcatbar = 5.E-05
        # self.dend3(0.5).k2_cc.gbar = 0.0005
        # self.dend3(0.5).cal_cc.gbar = 0.0002
        # self.dend3(0.5).ar.gbar = 2.5E-05
        # self.dend3(0.5).cad.beta = 0.05
        # self.dend3(0.5).cad.phi = 520000.
        ...
        # self.dend4(0.5).km.gbar = 0.0005
        # self.dend4(0.5).kahp_slower.gbar = 0.0001
        # self.dend4(0.5).cat.gcatbar = 5.E-05
        # self.dend4(0.5).k2_cc.gbar = 0.0005
        # self.dend4(0.5).cal_cc.gbar = 0.0002
        # self.dend4(0.5).ar.gbar = 2.5E-05
        # self.dend4(0.5).cad.beta = 0.05
        # self.dend4(0.5).cad.phi = 520000.
        ...
        # ---------------axon----------------
        # for mechanism_a in ['Nafin', 'kdrin', 'ka', 'k2', 'pas']:
        #     self.axon.insert(mechanism_a)
        # print(mechanism_a)
...
class LTS23(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        # self.dend1(0.5).kdr_fs.gbar = 0.1
        ...
        # self.dend2(0.5).naf2.gbar = 0.01
        # self.dend2(0.5).kdr_fs.gbar = 0.1
        ...
        # self.dend3(0.5).naf2.gbar = 0.01
        # self.dend3(0.5).kdr_fs.gbar = 0.1
        ...
        # self.dend4(0.5).naf2.gbar = 0.01
        # self.dend4(0.5).kdr_fs.gbar = 0.1
        ...
        for mechanism_a in ['Nafin', 'kdrin', 'pas']:
            self.axon.insert(mechanism_a)
        #     print(mechanism_a)
        # for mechanism_a in ['naf2', 'kdr_fs',
        #                     'pas']:
        #     self.axon.insert(mechanism_a)
...
class Spinstel4(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        # self.soma(0.5).kahp_slower.gbar = 0.0001
        # self.soma(0.5).cal.gcalbar = 0.0005
        # self.soma(0.5).cat.gcatbar = 0.0001
        ...
        # self.dend(0.5).kahp_slower.gbar = 0.0001
        # self.dend(0.5).cal.gcalbar = 0.0005
        ...
        # self.dend1(0.5).naf2.gbar = 0.075
        # self.dend1(0.5).napf_spinstell.gbar = 7.5E-05
        # self.dend1(0.5).kdr_fs.gbar = 0.075
        # self.dend1(0.5).kc_fast.gbar = 0.01
        # self.dend1(0.5).ka.gbar = 0.002
        # self.dend1(0.5).km.gbar = 0.00375
        # self.dend1(0.5).k2.gbar = 0.0001
        # self.dend1(0.5).kahp_slower.gbar = 0.0001
        # self.dend1(0.5).cal.gcalbar = 0.0005
        # self.dend1(0.5).cat.gcatbar = 0.0001
        ...
        # self.dend2(0.5).naf2.gbar = 0.005
        # self.dend2(0.5).napf_spinstell.gbar = 5.5E-06
        # self.dend2(0.5).kc_fast.gbar = 0.01
        # self.dend2(0.5).ka.gbar = 0.03
        # self.dend2(0.5).km.gbar = 0.00375
        # self.dend2(0.5).k2.gbar = 0.0001
        # self.dend2(0.5).kahp_slower.gbar = 0.0001
        # self.dend2(0.5).cal.gcalbar = 0.0005
        # self.dend2(0.5).cat.gcatbar = 0.0001
        ...
        # self.dend2(0.5).naf2.gbar = 0.005
        # self.dend2(0.5).napf_spinstell.gbar = 5E-06
        # self.dend2(0.5).ka.gbar = 0.002
        # self.dend2(0.5).km.gbar = 0.00375
        # self.dend2(0.5).k2.gbar = 0.0001
        # self.dend2(0.5).kahp_slower.gbar = 0.0001
        # self.dend2(0.5).cal.gcalbar = 0.0005
...
class TuftIB5(Cell):
    def __init__(self, x, y, z, num):
        ...
        # self.soma(0.5).nap.gnapbar = 0.0008 * 0.2  # 0.00006
        ...
        # self.soma(0.5).cat.gcatbar = 0.0001  # 5.E-05
        ...
        # ---------------axon----------------
        # for mechanism_a in ['Nafin', 'kdrin', 'ka_ib',
        #                     'km', 'k2', 'pas']:
        #     self.axon.insert(mechanism_a)
        #     # print(mechanism_a)
        ...
        # self.axon(0.5).Naf.gnafbar = 0.2
        # self.axon(0.5).kdr.gkdrbar = 0.17
...
class TuftRS5(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        # ---------------soma----------------
        # for mechanism_s in ['extracellular', 'napf',
        #                     'pas', 'naf2_cc',
        #                     'kdr_fs_cc', 'kc',
        #                     'ka_cc', 'km_cc', 'k2_cc',
        #                     'kahp_slower',
        ...
        # self.soma(0.5).naf2_cc.gbar = 0.2  # 0.6
        # self.soma(0.5).napf.gbar = 0.0008  # 0.00006
        # self.soma(0.5).kdr_fs_cc.gbar = 0.17  # 0.5
        ...
        # self.soma(0.5).kahp_slower.gbar = 0.0002  # 0.0001
        self.soma(0.5).kahp_deeppyr.gbar = 0.0002  # 0.0001
        self.soma(0.5).cal_cc.gbar = 0.004*0.4  # 0.0001
        self.soma(0.5).cat_a.gbar = 0.0001  # 5.E-05
        # self.soma(0.5).cat_a.gcatbar = 0.0001  # 5.E-05
        self.soma(0.5).ar.gbar = 0.0001  # 2.5E-05
        ...
        # self.dend(0.5).naf2.gbar =   0.2
        # self.dend(0.5).naf_tcr.gbar = 0.075  # 0.1 level 2 in modeldb
        # self.dend(0.5).napf_tcr.gbar = 0.0003  # 0.0002
        ...
        # self.dend1(0.5).naf_tcr.gbar = 0.015  # 0.1
        # self.dend1(0.5).napf_tcr.gbar = 6.E-05  # 0.0002
        # self.dend1(0.5).kdr_thlms.gbar = 0.075
        ...
        # self.dend2(0.5).naf_tcr.gbar = 0.015  # 0.1 level 4 in modeldb
        # self.dend2(0.5).napf_tcr.gbar = 6.E-05  # 0.0002
        # self.dend2(0.5).kdr_thlms.gbar = 0.075
        ...
        # self.dend3(0.5).naf_tcr.gbar = 0.15  # 0.1
        # self.dend3(0.5).napf_tcr.gbar = 0.0006  # 0.0002
        # self.dend3(0.5).kdr_thlms.gbar = 0.12  # 0.075
        ...
        # self.dend4(0.5).naf_tcr.gbar = 0.075  # 0.1
        # self.dend4(0.5).napf_tcr.gbar = 0.0003  # 0.0002
        # self.dend4(0.5).kdr_thlms.gbar = 0.075
        ...
        self.axon(0.5).Nafin.gnafbar = 0.45  # 0.4
        self.axon(0.5).kdrin.gkdrbar = 0.45  # 0.001
        # self.axon(0.5).Naf.gnafbar = 0.45
        # self.axon(0.5).kdr.gkdrbar = 0.45
...
class Bask56(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        # for mechanism_d in ['naf2_cc', 'kdr_fs',
        #                     'kc_fast', 'pas', 'ka',
        #                     'cal', 'cad']:
        #     self.dend.insert(mechanism_d)
        #     self.dend1.insert(mechanism_d)
        ...
        # self.dend2(0.5).kc_fast.gbar = 0.025
        # self.dend2(0.5).ka.gbar = 0.001
        # self.dend2(0.5).cal.gcalbar = 0.0001
        # self.dend2(0.5).cad.beta = 0.05
        # self.dend2(0.5).cad.phi = 520000.
        self.dend2(0.5).pas.g = 0.01
        self.dend2(0.5).pas.e = -65  # -73
        ...
        self.dend3(0.5).kdrin.gkdrbar = 0.01  # 0.018 * 0.5
        self.dend3(0.5).kapin.gkabar = 0.001  # 0.000032  # * 15 * 10
        # self.dend3(0.5).naf2_cc.gbar = 0.01
        # self.dend3(0.5).kdr_fs.gbar = 0.1
        # self.dend3(0.5).kc_fast.gbar = 0.025
        # self.dend3(0.5).ka.gbar = 0.001
        # self.dend3(0.5).cal.gcalbar = 0.0002
        ...
        self.dend4(0.5).kapin.gkabar = 0.001  # 0.000032  # * 15 * 10
        # self.dend4(0.5).naf2_cc.gbar = 0.01
        # self.dend4(0.5).kdr_fs.gbar = 0.1
        # self.dend4(0.5).kc_fast.gbar = 0.025
        # self.dend4(0.5).ka.gbar = 0.001
        # self.dend4(0.5).cal.gcalbar = 0.0002
...
class NontuftRS6(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        # self.dend(0.5).naf2.gbar =   0.2
        # self.dend(0.5).naf_tcr.gbar = 0.075  # 0.1
        ...
        # self.dend1(0.5).naf_tcr.gbar = 0.005  # 0.1
        # self.dend1(0.5).napf_tcr.gbar = 2E-05  # 0.0002
        ...
        # self.dend2(0.5).naf_tcr.gbar = 0.005  # 0.1
        # self.dend2(0.5).napf_tcr.gbar = 2E-05  # 0.0002
...
class SyppyrRS(Cell):  #
    def __init__(self, x, y, z, num):
        ...
        for mechanism_s in ['extracellular', 'Naf', 'nap',
            ...
            # print(mechanism_s)
            self.soma.insert(mechanism_s)
        # for mechanism_s in ['extracellular', 'Naf', 'nap', 'cal',
        #                     'can', 'cat', 'car',
        #                     'ka', 'kdr_fs_cc',
        #                     'kca', 'ar',
        #                     'cad', 'pas']:
