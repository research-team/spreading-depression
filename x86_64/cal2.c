...
#define minf minf_cal
 double minf = 0;
#define scaletau scaletau_cal
 double scaletau = 0.333333;
#define shiftm shiftm_cal
 double shiftm = 10;
#define tau tau_cal
 double tau = 0;
#define tfa tfa_cal
...
#define usetable usetable_cal
 ...
 "ki_cal", &ki_cal,
 "tfa_cal", &tfa_cal,
 "shiftm_cal", &shiftm_cal,
 "scaletau_cal", &scaletau_cal,
 "minf_cal", &minf_cal,
 "tau_cal", &tau_cal,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal /home/kseniia/Documents/spreadingDepression/spreading-depression/x86_64/cal2.mod\n");
...
static void _hoc_efun(void) {
 ...
 static void _check_alp() {
  ...
  static double _sav_scaletau;
  if (!usetable) {return;}
  if (_sav_shiftm != shiftm) { _maktable = 1;}
  if (_sav_scaletau != scaletau) { _maktable = 1;}
...
double _f_alp (  double _lv ) {
   double _lalp;
 _lalp = scaletau * 15.69 * ( - 1.0 * _lv - shiftm + 81.5 ) / ( exp ( ( - 1.0 * _lv - shiftm + 81.5 ) / 10.0 ) - 1.0 ) ;
...
double _f_bet (  double _lv ) {
   double _lbet;
 _lbet = scaletau * 0.29 * exp ( ( - _lv - shiftm ) / 10.86 ) ;
 ...
 v=_v;
{
  ...
  eca = _ion_eca;
 { error =  state();
 if(error){fprintf(stderr,"at line 52 in file cal2.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kseniia/Documents/spreadingDepression/spreading-depression/cal2.mod";
static const char* nmodl_file_text = 
