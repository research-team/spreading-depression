...
#define nrn_init _nrn_init__nastim
#define _nrn_initial _nrn_initial__nastim
#define nrn_cur _nrn_cur__nastim
#define _nrn_current _nrn_current__nastim
#define nrn_jacob _nrn_jacob__nastim
#define nrn_state _nrn_state__nastim
#define _net_receive _net_receive__nastim 
