...
#define nrn_init _nrn_init__Hzclamp
#define _nrn_initial _nrn_initial__Hzclamp
#define nrn_cur _nrn_cur__Hzclamp
#define _nrn_current _nrn_current__Hzclamp
#define nrn_jacob _nrn_jacob__Hzclamp
#define nrn_state _nrn_state__Hzclamp
#define _net_receive _net_receive__Hzclamp 
#define state state__Hzclamp 
